...
var G__30349 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__30349;
continue;
} else {
return ch;
...
var vec__30332 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30332,(0),null);
return (match === s);
});
...
while(true){
if((i__4731__auto___30422 < len__4730__auto___30419)){
args__4736__auto__.push((arguments[i__4731__auto___30422]));

var G__30425 = (i__4731__auto___30422 + (1));
i__4731__auto___30422 = G__30425;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq30338){
...
return (function() { 
var G__30429__delegate = function (rdr,_){
...
var G__30429 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__30430__i = 0, G__30430__a = new Array(arguments.length -  1);
while (G__30430__i < G__30430__a.length) {G__30430__a[G__30430__i] = arguments[G__30430__i + 1]; ++G__30430__i;}
  _ = new cljs.core.IndexedSeq(G__30430__a,0,null);
} 
return G__30429__delegate.call(this,rdr,_);};
G__30429.cljs$lang$maxFixedArity = 1;
G__30429.cljs$lang$applyTo = (function (arglist__30431){
var rdr = cljs.core.first(arglist__30431);
var _ = cljs.core.rest(arglist__30431);
return G__30429__delegate(rdr,_);
});
