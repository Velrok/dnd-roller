...
entries,ctx);this.clearActive()}};ResizeObserverSPI.prototype.clearActive=function(){this.activeObservations_.splice(0)};ResizeObserverSPI.prototype.hasActive=function(){return 0<this.activeObservations_.length};return ResizeObserverSPI}(),observers="undefined"!==typeof WeakMap?new WeakMap:new MapShim,ResizeObserver=function(){function ResizeObserver(callback){if(!(this instanceof ResizeObserver))throw new TypeError("Cannot call a class as a function.");if(!arguments.length)throw new TypeError("1 argument required, but only 0 present.");
var controller=ResizeObserverController.getInstance();controller=new ResizeObserverSPI(callback,controller,this);observers.set(this,controller)}return ResizeObserver}();["observe","unobserve","disconnect"].forEach(function(method){ResizeObserver.prototype[method]=function(){var _a;return(_a=observers.get(this))[method].apply(_a,arguments)}});var index$jscomp$0="undefined"!==typeof global$1.ResizeObserver?global$1.ResizeObserver:ResizeObserver;return index$jscomp$0})}
