...
var G__27220 = devtools.prefs.pref(v);
v = G__27220;
continue;
} else {
return v;
...
}catch (e27158){var _e__26380__auto__ = e27158;
return false;
}})();
...
}catch (e27165){var _e__26380__auto__ = e27165;
return false;
}})();
...
}catch (e27167){var _e__26380__auto__ = e27167;
return false;
}}
}
});
...
var vec__27198 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27198,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27198,(1),null);
...
return cljs.core.some((function (p1__27207_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27207_SHARP_);
}),template);
});
