...
var G__26991 = (i__4731__auto___26989 + (1));
i__4731__auto___26989 = G__26991;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq26908){
var G__26909 = cljs.core.first(seq26908);
var seq26908__$1 = cljs.core.next(seq26908);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26909,seq26908__$1);
});
...
return (p1__26912_SHARP_ === object);
});})(history))
,history);
});
...
var G__27007 = (i__4731__auto___27004 + (1));
i__4731__auto___27004 = G__27007;
continue;
} else {
}
break;
...
var argseq__4737__auto__ = ((((1) < args__4736__auto__.length))?(new cljs.core.IndexedSeq(args__4736__auto__.slice((1)),(0),null)):null);
return devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4737__auto__);
});

devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__26917){
var vec__26921 = p__26917;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26921,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq26914){
var G__26915 = cljs.core.first(seq26914);
var seq26914__$1 = cljs.core.next(seq26914);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26915,seq26914__$1);
});
...
var i__4731__auto___27015 = (0);
while(true){
if((i__4731__auto___27015 < len__4730__auto___27014)){
args__4736__auto__.push((arguments[i__4731__auto___27015]));

var G__27016 = (i__4731__auto___27015 + (1));
i__4731__auto___27015 = G__27016;
continue;
} else {
}
break;
...
return devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4737__auto__);
});

devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__26933){
var vec__26934 = p__26933;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26934,(0),null);
...
var _STAR_ = ((function (starting_index,vec__26934,seq_SINGLEQUOTE_d_map_QMARK_){
return (function (p__26937){
var vec__26938 = p__26937;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26938,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26938,(1),null);
if(cljs.core.truth_((function (){var and__4120__auto__ = seq_SINGLEQUOTE_d_map_QMARK_;
...
});})(starting_index,vec__26934,seq_SINGLEQUOTE_d_map_QMARK_))
;
...
/** @this {Function} */
devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq26928){
...
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26929,G__26930,seq26928__$2);
});
...
var valid_kw_QMARK_ = (function (){var and__4120__auto__ = first_kw;
if(cljs.core.truth_(and__4120__auto__)){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4131__auto__ = path;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return cljs.core.PersistentVector.EMPTY;
...
var or__4131__auto__ = devtools.formatters.state.ignore_path_in_fake_vector(parent_object,object,path_info);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = devtools.formatters.state.find_path_in_fake_vector(parent_object,path_info);
if(cljs.core.truth_(or__4131__auto____$1)){
return or__4131__auto____$1;
} else {
var or__4131__auto____$2 = devtools.formatters.state.find_path(parent_object,object,path_info);
