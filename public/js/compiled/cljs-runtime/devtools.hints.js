...
var G__26799 = cljs.core.PersistentArrayMap.EMPTY;
var G__26800 = native_stack_trace;
var G__26801 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__26802 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__26799,G__26800,G__26801,G__26802) : cljs.stacktrace.parse_stacktrace.call(null,G__26799,G__26800,G__26801,G__26802));
});
...
var map__26808 = top_item;
var map__26808__$1 = (((((!((map__26808 == null))))?(((((map__26808.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26808.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26808):map__26808);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26808__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26808__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26808__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e26807){var _e = e26807;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___26872 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___26872)){
var seen_errors_26873 = temp__5718__auto___26872;
if(cljs.core.truth_(seen_errors_26873.has(self))){
} else {
seen_errors_26873.add(self);

var temp__5720__auto___26874 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___26874)){
var sense_26875 = temp__5720__auto___26874;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26875)].join('');
} else {
}
}
} else {
