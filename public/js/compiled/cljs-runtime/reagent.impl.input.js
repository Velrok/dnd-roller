...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__37394){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37395__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37395,map__37395__$1,on_write){
return (function (){
...
});})(node_value,map__37395,map__37395__$1,on_write))
);
} else {
...
this$.reagentRefFn = ((cljs.core.fn_QMARK_(original_ref_fn))?((function (v,value,on_change,original_ref_fn){
return (function (el){
this$.inputEl = el;
...
:(cljs.core.truth_((function (){var and__4120__auto__ = original_ref_fn;
...
return reagent.impl.input.input_handle_change(this$,on_change,p1__37440_SHARP_);
});})(v,value,on_change,original_ref_fn))
;
