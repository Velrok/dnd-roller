...
var o26883 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26883["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26884 = temp__5718__auto____$1;
return (o26884["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26338__auto__ = f;
return (o__26338__auto__["toString"]).call(o__26338__auto__);
} else {
return "";
}
}catch (e26892){var _ = e26892;
return "";
}});
...
try{var o__26338__auto___27142 = t;
(o__26338__auto___27142["cljs$lang$ctorPrWriter"]).call(o__26338__auto___27142,t,writer);
}catch (e26898){var __27143 = e26898;
}
...
var char_code = (function (){var o__26338__auto__ = (new String(char$));
return (o__26338__auto__["charCodeAt"]).call(o__26338__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26338__auto__ = String;
return (o__26338__auto__["fromCharCode"]).call(o__26338__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26910 = num_code;
switch (G__26910) {
case (1):
return (185);
...
var o__26338__auto__ = String;
return (o__26338__auto__["fromCharCode"]).call(o__26338__auto__,superscript_code);
});
/**
...
}catch (e26916){var _e__26380__auto__ = e26916;
return false;
}})())){
...
var vec__26918 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26918,(0),null);
...
var temp__5722__auto__ = (function (){var G__26949 = (devtools.munging.get_global_scope.cljs$core$IFn$_invoke$arity$0 ? devtools.munging.get_global_scope.cljs$core$IFn$_invoke$arity$0() : devtools.munging.get_global_scope.call(null));
var G__26950 = ns_module_name.split(".");
return goog.object.getValueByKeys(G__26949,G__26950);
})();
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26955){
var vec__26956 = p__26955;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26956,(0),null);
...
var G__27196 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27197 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27196;
remaining_tokens = G__27197;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26952){
var G__26954 = cljs.core.first(seq26952);
var seq26952__$1 = cljs.core.next(seq26952);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26954,seq26952__$1);
});
...
var vec__26978 = cljs.core.split_with((function (p1__26973_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26973_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26978,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26978,(1),null);
...
var vec__26984 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26984,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26984,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27205 = cljs.core.rest(remaining_tokens);
var G__27206 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27205;
name_tokens = G__27206;
continue;
} else {
...
var vec__26994 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26994,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26994,(1),null);
var vec__26997 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26997,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26997,(1),null);
var vec__27000 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27000,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27000,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27000,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27000,(3),null);
...
var vec__27011 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27018 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27018,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27018,(1),null);
var vec__27021 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27021,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27021,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27028 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27028) : devtools.munging.parse_fn_info_deep.call(null,G__27028));
})()));
}
} else {
return fn_info;
...
var G__27229 = (arity + (1));
var G__27230 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27048){
var vec__27049 = p__27048;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27049,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27049,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27064_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27065_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27075){
var vec__27076 = p__27075;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27076,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27069){
var G__27070 = cljs.core.first(seq27069);
var seq27069__$1 = cljs.core.next(seq27069);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27070,seq27069__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27102__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27102__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27102__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27102__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27103 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27103,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27103,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27103,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27103,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27103,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27103,(5),null);
...
var o__26338__auto__ = f;
return (o__26338__auto__["getBasis"]).call(o__26338__auto__);
});
/**
...
}catch (e27118){var _e__26380__auto__ = e27118;
...
var G__27264 = (obj[cljs.core.first(path)]);
var G__27265 = cljs.core.rest(path);
obj = G__27264;
path = G__27265;
continue;
} else {
...
return (function (accum,p__27123){
var vec__27124 = p__27123;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27124,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27124,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27127){
var vec__27128 = p__27127;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27128,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27128,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27128,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27139,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27139,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__27139,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27134_SHARP_){
return (obj[cljs.core.first(p1__27134_SHARP_)]);
});})(name,sorted_matches,vec__27139,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
